 ...
 * (plain SHA1/XOR, no library) against the real scramble Warp sent and matched exactly.
 ...
 * fixable in Warp. Disabled rather than deleted so re-enabling is the regression check if
 * this ever turns out to be on Warp's side after all. */
class MyWireTest {
